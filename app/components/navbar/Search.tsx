...
const Search = ({ isDefaultSearchBar }: { isDefaultSearchBar: boolean }) => {
    ...
    function defaultSearchBar() {
        return (
            ...
            >
                <div className='flex flex-row items-center justify-between'>
                    <button className='text-sm font-semibold md:px-6 px-4 py-3 text-base  hover:bg-tertiary transition cursor-pointer rounded-full'>Logements</button>
                    <button className='text-sm font-semibold md:px-6 px-4 py-3 text-base hover:bg-tertiary transition cursor-pointer rounded-full'>Expériences</button>
                    <button className='text-sm font-semibold md:px-6 px-4 py-3 text-base hover:bg-tertiary transition cursor-pointer rounded-full'>Expériences en ligne</button>
                </div>
            </div >
        )
    }
